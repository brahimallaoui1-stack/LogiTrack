        ...
        return (
            <div className="flex items-center justify-center h-screen">
                <div className="flex flex-col items-center gap-4">
                    <Image src="/icons/icon-192x192.png" alt="LogiTrack Logo" width={48} height={48} className="animate-pulse" />
        ...
        <Sidebar>
            <SidebarHeader className="p-4">
                ...
                <Link href="/" className="flex items-center gap-3">
                    <Image src="/icons/icon-192x192.png" alt="LogiTrack Logo" width={32} height={32} />
